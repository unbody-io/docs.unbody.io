...
The API Layer bridges your application and Unbody’s backend. For integrating the outputs into your frontend, explore the [Frontend Layer](https://chatgpt.com/g/g-9N3RT50W3-unbody-ea/c/frontend-layer.md).