...
# Multimodal using generative search

Use generative search capabilities to analyze multiple images and their associated metadata comprehensively.

## Image Analysis with Metadata
This example demonstrates how to analyze multiple images along with their metadata, OCR text, and auto-generated captions. It combines visual content analysis with textual information to provide detailed insights.
...
Learn more about advanced multimodal search features in our [Advanced Multimodal Search Guide](/guides/advanced-multimodal-search).
