...
Vectorization converts enriched data into embeddings, enabling semantic tasks like [search](/content-api/search/semantic-search) and clustering:
...
- **Traditional Database Functions:** Apply filtering with [where](/content-api/filters) clauses, grouping data by metadata, and [sort](/content-api/sorting) results for structured queries.
