...
Assuming you've already has gone through the [step 1](/get-started/step-1-setup) and [step 2](/get-started/step-2-building), let's now make your first API call with Discord messages.
