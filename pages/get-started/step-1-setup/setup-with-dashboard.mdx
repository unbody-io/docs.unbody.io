...
This step will happen all on [Unbody’s dashboard](https://app.unbody.io/projects). Via the dashboard, you can manage anything about your account, subscription, projects, and more.
...
<Steps>
    ...
    <Steps>
        ...
        Choose the platform where your content is stored. For example, if it's stored in Google Drive, select it as the content provider. Visit [providers](/providers/overview) for more information.
        ![Select provider](/images/docs/get-started/providers.jpg)

        ### Connect Unbody to your source

        Allow Unbody to access your content from the selected provider. Learn more about this on [our privacy page](https://github.com/unbody-io/docs.unbody.io/?tab=MIT-1-ov-file#readme).
...
<PageCard
    ...
    link="/get-started/step-2-building"
