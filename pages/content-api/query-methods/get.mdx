...
- **`nearText`:** This argument helps you find objects that are semantically similar to the given text. You can learn more about semantic search [here](/content-api/search/semantic-search).
