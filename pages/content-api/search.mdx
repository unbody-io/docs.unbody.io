...
<Callout>
    We assume that you have already read and learn about how to setup unbody project and also learn about the basics how to make request calls to Unbody API. If not please go to [getting started](/get-started) and have make sure you have followed all the steps.
</Callout>
...
- [Keyword search](/graphql-api/search/keyword-search)
- [Hybrid search](/graphql-api/search/hybrid-search)
...
- [Record similarity](/graphql-api/search/record-similarity)
- [Visual similarity](/graphql-api/search/visual-similarity)
