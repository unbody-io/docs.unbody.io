...
We can keep the complex type details in the code examples or in a separate type reference section if needed. This makes the table much more readable while still conveying the essential information.
