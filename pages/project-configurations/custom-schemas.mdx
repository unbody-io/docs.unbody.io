...
---
{/*  TODO: currently there is no way to set custom schema from dashboard
## **Configuring Custom Schemas**

Custom Schemas can be configured via the [**Dashboard**](https://app.unbody.io/projects) or programmatically using the [**Admin API**](/admin-api).

---

### **1. Dashboard Setup**

1. Go to your [**Project Settings**](https://app.unbody.io/projects).
...
You can define and manage Custom Schemas programmatically. Learn more about [Admin API](/admin-api)
