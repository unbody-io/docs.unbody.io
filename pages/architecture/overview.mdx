...
![Unbody Architecture Overview](/images/docs/arch.png)

To understand Unbody’s architecture, it’s important to first understand its philosophy—and [why it exists](../why).
...
We define **AI-native** as products that don’t just use AI but are designed to **understand humans, respond intelligently, and adapt to user needs**. Achieving this required us to rethink software architecture entirely, centering it around three principles:
...
3. **Responsive Aganecy**: Build a foundation that not only adjusts to user input but also enables systems to act autonomously and intelligently.
