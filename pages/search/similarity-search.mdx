...
## Text Similarity
Let's say you have several documents about AI technology and want to find related content discussing machine learning advancements. This example shows how to search across your documents to find conceptually related content.
...
Need to discover content that aligns with specific concepts while maintaining high relevance? Advanced text similarity lets you steer your search toward particular themes or topics while filtering out unrelated results.
...
## Image Similarity
Looking for images that share visual characteristics like colors, objects, or composition? Image similarity search helps you find visually related content regardless of filenames or metadata.
...
## Record Similarity
Found a valuable document and want to discover similar content? Record similarity uses an existing document as a reference point to uncover related records that might be missed through traditional search methods.
