...
For more details on configuring project settings, see the [Project Settings Guide](https://www.notion.so/Admin-API-1590b5596dd88008abc6c178d258eaef?pvs=21)
...
See the [Filterable Properties for Projects](https://www.notion.so/Admin-API-1590b5596dd88008abc6c178d258eaef?pvs=21) and [Filterable Properties for Sources](https://www.notion.so/Admin-API-1590b5596dd88008abc6c178d258eaef?pvs=21).
...
- **List Projects**
  ...
  - **Method**: `GET`
  - **Path**: `/projects`
  - **Filterable Fields**: [Reference](https://www.notion.so/Admin-API-1590b5596dd88008abc6c178d258eaef?pvs=21)
...
| --- | --- | --- |
| `name` | string | [String Filter Operators](https://www.notion.so/Admin-API-1590b5596dd88008abc6c178d258eaef?pvs=21) |
| [`state`](https://www.notion.so/Admin-API-1590b5596dd88008abc6c178d258eaef?pvs=21) | enum | [Enum Filter Operators](https://www.notion.so/Admin-API-1590b5596dd88008abc6c178d258eaef?pvs=21) |
| `pausedAt` | Date | [Date Filter Operators](https://www.notion.so/Admin-API-1590b5596dd88008abc6c178d258eaef?pvs=21) |
| `restoredAt` | Date | [Date Filter Operators](https://www.notion.so/Admin-API-1590b5596dd88008abc6c178d258eaef?pvs=21) |
| `createdAt` | Date | [Date Filter Operators](https://www.notion.so/Admin-API-1590b5596dd88008abc6c178d258eaef?pvs=21) |
| `updatedAt` | Date | [Date Filter Operators](https://www.notion.so/Admin-API-1590b5596dd88008abc6c178d258eaef?pvs=21) |
...
| --- | --- | --- |
| `name` | string | [String Filter Operators](https://www.notion.so/Admin-API-1590b5596dd88008abc6c178d258eaef?pvs=21) |
| `initialized` | boolean | [Boolean Filter Operators](https://www.notion.so/Admin-API-1590b5596dd88008abc6c178d258eaef?pvs=21) |
| [`state`](https://www.notion.so/Admin-API-1590b5596dd88008abc6c178d258eaef?pvs=21) | enum | [Enum Filter Operators](https://www.notion.so/Admin-API-1590b5596dd88008abc6c178d258eaef?pvs=21) |
| [`type`](https://www.notion.so/Admin-API-1590b5596dd88008abc6c178d258eaef?pvs=21) | enum | [Enum Filter Operators](https://www.notion.so/Admin-API-1590b5596dd88008abc6c178d258eaef?pvs=21) |
| `pausedAt` | Date | [Date Filter Operators](https://www.notion.so/Admin-API-1590b5596dd88008abc6c178d258eaef?pvs=21) |
| `restoredAt` | Date | [Date Filter Operators](https://www.notion.so/Admin-API-1590b5596dd88008abc6c178d258eaef?pvs=21) |
| `createdAt` | Date | [Date Filter Operators](https://www.notion.so/Admin-API-1590b5596dd88008abc6c178d258eaef?pvs=21) |
| `updatedAt` | Date | [Date Filter Operators](https://www.notion.so/Admin-API-1590b5596dd88008abc6c178d258eaef?pvs=21) |
