...
## Basic Image Query
Fetch basic image information including OCR text and auto-generated captions.
...
<Tabs items={['Unbody SDK', 'GraphQL']}>
  <Tabs.Tab>
    ```typescript
    const data = await unbody.get.imageBlock.similar
        .image(
...
Learn more about advanced image features in our [Advanced Image Guide](/guides/advanced-image).
